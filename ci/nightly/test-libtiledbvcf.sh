...
$GITHUB_WORKSPACE/build-libtiledbvcf/libtiledbvcf/test/tiledb_vcf_unit

# cli tests (require bcftools)
# USAGE: run-cli-tests.sh <build-dir> <inputs-dir>
$GITHUB_WORKSPACE/TileDB-VCF/libtiledbvcf/test/run-cli-tests.sh build-libtiledbvcf TileDB-VCF/libtiledbvcf/test/inputs
